...
![image-20230419170230122](./images/image-20230419170230122.png)
...
import com.nakanomay.springcloud.entities.CommonResult;
import com.nakanomay.springcloud.entities.Payment;
import com.nakanomay.springcloud.service.PaymentFeignService;
...
![img](./images/6C01D7E2-8711-4F63-BFA6-8D3D74BF5D35.png)
...
logging:
  level:
    # feign日志以什么级别监控哪个接口
    com.nakanomay.springcloud.service.PaymentFeignService: debug
```
