...
```java
    ...
    @GetMapping("/consumer/payment/postCreateEntity")
    public ResponseEntity<CommonResult> postCreateEntity(Payment payment)
    {
...
4.在com.nakanomay.myrule下新建MySelfRule规则类
...
```java
import com.nakanomay.myrule.MySelfRule;
...
import com.nakanomay.springcloud.lb.LoadBalancer;
