...
![](./images/8078abc7f846e58388c282220840b6950b34f7a2.png)

### 12.1.2 正则表达式“按位”描述规则

正则表达式“按位”描述规则，是指它是一位一位的描述字符串的构成形式。

比如检查字符串是不是这样的：以字母 m 开头，然后是 3 个数字，最后以字母 n 结尾。

![](./images/38f50c0c87e71751054dcc9e418a8a3c458e9a4b.png)
...
![](./images/ba274bb2b715f50781a4196c492803048408b00e.png)
...
### 12.4.2 String.prototype.search()
...
### 12.4.3 String.prototype.replace()
