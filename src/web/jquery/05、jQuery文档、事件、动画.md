...
![fadeOut、fadeIn、fadeToggle](./images/iokqpnIrT3bcfRg.gif)
...
![slideUp、slideDown、slideToggle](./images/5KrgvmidEXLWqwt.gif)
...
![show、hide、toggle](./images/YiyxuZpPNvKMGoV.gif)
