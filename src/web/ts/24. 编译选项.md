...
| 选项                                                                                                                      | 类型        | 默认值     | 描述                                          |
| ----------------------------------------------------------------------------------------------------------------------- | --------- | ------- | ------------------------------------------- |
| [`allowJs`](https://ts.xcatliu.com/engineering/compiler-options.html#allowjs)                                           | `boolean` | `false` | 允许编译 js 文件                                  |
| [`allowSyntheticDefaultImports`](https://ts.xcatliu.com/engineering/compiler-options.html#allowsyntheticdefaultimports) | `boolean` | `false` | 允许对不包含默认导出的模块使用默认导入。这个选项不会影响生成的代码，只会影响类型检查。 |
