...
第一个参数以下划线开头即可，参考 [with --noUnusedParameters how can i skip uneeded parameters · Issue #9458 · microsoft/TypeScript · GitHub](https://github.com/Microsoft/TypeScript/issues/9458)
