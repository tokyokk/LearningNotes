...
![动画  (3)](./images/XeaB1EYMn7RKkZi.gif)
...
![动画  (4)](./images/bJGORgZUBh2HYt9.gif)
...
![动画  (6)](./images/g6ZGYk5H42EUsCz.gif)
...
![动画  (7)](./images/2w6PCHSpkXMKFlJ.gif)
...
![动画  (8)](./images/B1owhmPvlGeyfra.gif)
...
![动画  (8)](./images/N7wOZpi4IhgAt1l.gif)

> **记低级失误**：
>
> 1、将
>
> @Controller @RequestMapping("/fileUploadDownloadController")
>
> 写成了
>
...
![动画  (9)](./images/sUvlI9QcatMVdJf.gif)

查看文件是否上传成功

![image-20220330224959389](./images/s9y1CDr5V2WHiRd.png)
...
![image-20220330230259507](./images/fGLcVTKmu6ZkPYn.png)
...
![06-HttpMessageConverter](./images/osh6P2AWMjmlYz9.png)