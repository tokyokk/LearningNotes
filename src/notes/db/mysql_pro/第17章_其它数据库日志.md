...
![image-20220329180747441](./images/image-20220329180747441.png)
...
![image-20220329184556306](./images/image-20220329184556306.png)
...
![image-20220329212518542](./images/image-20220329212518542.png)

最早的数据情况。

![image-20220329205328322](./images/image-20220329205328322.png)

下图 Pos  236 到1071 是张三林俊杰、张三3 生成的sql

![image-20220329211054299](./images/image-20220329211054299.png)

不小心改错了成这样了。

![image-20220329212708613](./images/image-20220329212708613.png)
...
![image-20220329213102535](./images/image-20220329213102535.png)

因为id 3只是修改。所以，后面又创建id3 就报错了。

![image-20220329213254839](./images/image-20220329213254839.png)
...
![image-20220329182236159](./images/image-20220329182236159.png)
...
![image-20220329182304420](./images/image-20220329182304420.png)

为了安全起见，可以设置为 `1` ，表示每次提交事务都会执行fsync，就如同 **redo log 刷盘流程** 一样。最后还有一种折中方式，可以设置为N(N>1)，表示每次提交事务都write，但累积N个事务后才fsync。

![image-20220329182335630](./images/image-20220329182335630.png)
...
![image-20220329182419294](./images/image-20220329182419294.png)
