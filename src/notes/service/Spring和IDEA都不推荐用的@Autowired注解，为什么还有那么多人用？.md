...
![图片](./images/640-20230513235352065.png)
...
![图片](./images/640-20230513235407537.png)
...
![图片](./images/640-20230513235411206.png)

**@Resource的装配顺序如下：**

1. 如果同时指定了name和type：

![图片](./images/640-20230513235424337.png)

2. 如果指定了name：

![图片](./images/640-20230513235425050.png)

3. 如果指定了type：

![图片](./images/640-20230513235432318.png)

4. 如果既没有指定name，也没有指定type：

![图片](./images/640-20230513235437173.png)
