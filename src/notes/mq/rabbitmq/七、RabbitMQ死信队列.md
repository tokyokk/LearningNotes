...
![image](./images/image.691xh9mh3yk0.webp)
...
![image](./images/image.5ldx5kffws00.webp)

**生产者发送了10条消息，此时正常消息队列有10条未消费消息**

![image](./images/image.4k5fjvtukpe0.webp)

**时间过去10秒，正常队列里面的消息由于没有被消费，消息进入死信队列**

![image](./images/image.5g2svti1sec0.webp)
...
![image](./images/image.3a1tkaqx5jm0.webp)

- 控制台

![image](./images/image.2qvoqd9bcdc0.webp)
...
![image](./images/image.6nv41w7ky0o0.webp)

- 启动 C2 消费者

![image](./images/image.3mg5ph9jr020.webp)

- 控制台

![image](./images/image.664h3njwl6w0.webp)
...
![image](./images/image.ncokzmns2t.webp)

- 启动消费者 C1 等待 10 秒之后，再启动消费者 C2

![image](./images/image.1xxchsmgsgdc.webp)

- C1控制台

![image](./images/image.5zgbkg8gij80.webp)

- C2控制台

![image](./images/image.783con5n7f40.webp)