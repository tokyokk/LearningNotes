...
简单的发布确认机制在`应答与签收`已经介绍，本内容将介绍整合了 SpringBoot 的发布确认机制。
...
![image](./images/image.7c8btl8ibwo0.webp)
...
![image](./images/image.7ddz8ceuxk40.webp)
...
[http://localhost:8888/confirm/sendMessage/大家好1(opens new window)](http://localhost:8888/confirm/sendMessage/大家好1)

结果分析:

![image](./images/image.5cpvzjf8zb40.webp)
...
![image](./images/image.6ag1qfe3xws0.webp)
...
![image](./images/image.109ugczigfdc.webp)
...
![image](./images/image.42foi4mawzq0.webp)
