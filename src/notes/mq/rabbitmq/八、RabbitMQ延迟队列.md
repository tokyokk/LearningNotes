...
![image](./images/image.21tyby27zrog.webp)
...
![RabbitMQ-00000058](./images/RabbitMQ-00000058.png)

2. 添加依赖，这里的 Spring Boot 是2.3.12 版本
...
public class SwaggerConfig {
    ...
    private ApiInfo webApiInfo() {
        return new ApiInfoBuilder()
                ...
                .version("1.0")
                .contact(new Contact("may", "http://nakanomay.com", "test@qq.com"))
                .build();
    }
...
![image](./images/image.6ipia9redgw0.webp)
...
**Controller 层代码，发送消息，读取 RabbitMQ** 里的消息
...
![image](./images/image.2x90cjk4j3c0.webp)
...
![image](./images/image.267zky9xj8dc.webp)
...
> **出现问题**:
>
> ![1658765665496](./images/1658765665496.39yyrmljat80.webp)
...
![image](./images/image.3nqc69j0pws0.webp)

## 07、插件实战

在这里新增了一个队列 delayed.queue，一个自定义交换机 delayed.exchange，绑定关系如下:

![image](./images/image.1tla4z5g4yps.webp)
...
![image](./images/image.17h77dwilchs.webp)
